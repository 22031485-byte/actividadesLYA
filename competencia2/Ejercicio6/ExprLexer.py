...
def serializedATN():
    return [
        ...
        0,4,1,1,3,2,5,3,7,4,1,0,2,1,0,48,57,2,0,9,10,13,13,26,0,1,1,0,0,
        ...
        0,12,10,1,0,0,0,12,13,1,0,0,0,13,2,1,0,0,0,14,15,5,42,0,0,15,4,1,
        0,0,0,16,17,5,43,0,0,17,6,1,0,0,0,18,20,7,1,0,0,19,18,1,0,0,0,20,
...
class ExprLexer(Lexer):
    ...
    symbolicNames = [ "<INVALID>",
            "NUM", "OP_MUL", "OPE_SUM", "WS" ]

    ruleNames = [ "NUM", "OP_MUL", "OPE_SUM", "WS" ]
